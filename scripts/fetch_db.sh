...
# Tools required:  bash, coreutils (chmod, cut, mkdir, printf, sort), dmrRadio, grep, wget
...
wget --continue --no-hsts --output-document=tmp/user.csv https://database.radioid.net/static/user.csv

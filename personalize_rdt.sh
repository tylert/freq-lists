...
jq --slurp '.[0] * .[1]' tmp/Retevis_RT90.json tmp/VA3DGN-A.json \
    | jq '.GeneralSettings.IntroScreenLine1 |= "VA3DGN-9"' \
    | jq '.GeneralSettings.RadioName |= "VA3DGN-9"' > tmp/VA3DGN-9.json
jq --slurp '.[0] * .[1]' tmp/Retevis_RT90.json tmp/VA3DGN-B.json \
...
jq --slurp '.[0] * .[1]' tmp/Retevis_RT3S.json tmp/VA3DGN-A.json \
    | jq '.GeneralSettings.IntroScreenLine1 |= "VA3DGN-7"' \
    | jq '.GeneralSettings.RadioName |= "VA3DGN-7"' > tmp/VA3DGN-7.json
jq --slurp '.[0] * .[1]' tmp/Retevis_RT3S.json tmp/VA3DGN-B.json \

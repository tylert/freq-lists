...
| .GeneralSettings.BacklightTime |= "Always"            # in seconds;  "Always", "5", "10", "15"
...
| .GeneralSettings.MenuControl |= "On"                  # "Off", "On"
| .GeneralSettings.TwoChannel |= "On"                   # "Off", "On"
...
# Radio Buttons
| .RadioButtons[0] |= {"Button": "Unassigned (default)"}   # Top Button 1 Short Press
| .RadioButtons[1] |= {"Button": "Unassigned (default)"}   # Top Button 1 Long Press
| .RadioButtons[2] |= {"Button": "Unassigned (default)"}   # Side Button 1 Short Press
| .RadioButtons[3] |= {"Button": "Unassigned (default)"}   # Side Button 1 Long Press
| .RadioButtons[4] |= {"Button": "Unassigned (default)"}   # Side Button 2 Short Press
